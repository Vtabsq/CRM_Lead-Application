...
def get_billing_history(patient_name: str) -> List[Dict[str, Any]]:
    """
    Get billing history for a home care client from Accounts Receivable sheet.
...
def generate_homecare_invoice(client_record: Dict[str, Any]) -> Dict[str, Any]:
    """
    Generate invoice for a home care client and save to Accounts Receivable sheet.
