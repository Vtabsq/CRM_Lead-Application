...
const PatientAdmissionBillingPreview = () => {
    ...
    const fetchBillingPreview = async () => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/patientadmission/billing-preview?days=${previewDays}`);
            ...
            <div className="mb-6">
                <div className="flex justify-between items-center mb-4">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Upcoming patient admission billing schedule</p>
                    </div>
                    <button
                            ...
                            upcomingBills.map((bill, index) => (
                                <tr key={index} className="hover:bg-gray-50">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <button
                                            onClick={() => navigate(`/patientadmission/billing-history/${encodeURIComponent(bill.patient_name)}`)}
...
export default PatientAdmissionBillingPreview;
