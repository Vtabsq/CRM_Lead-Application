        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-green-50 to-blue-100 p-6">
            <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-xl shadow-xl p-6 mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white">Invoice Upload Monitor</h1>
                        <p className="text-blue-100 text-sm">Monitor invoice upload status</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Invoice Upload Monitor</h2>
