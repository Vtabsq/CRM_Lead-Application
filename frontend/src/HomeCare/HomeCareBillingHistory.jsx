...
const HomeCareBillingHistory = () => {
    ...
    const fetchBillingHistory = async () => {
        try {
            const response = await fetch(`${API_BASE_URL}/api/homecare/billing-history/${encodeURIComponent(patientName)}`);
...
export default HomeCareBillingHistory;
